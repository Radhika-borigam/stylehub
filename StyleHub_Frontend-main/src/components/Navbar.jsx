...
const Navbar = ({ DrawerList }) => {
  ...
  return (
    <div className="h-[10vh] flex items-center justify-between px-5 border-b bg-white shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <h1
          onClick={() => navigate("/")}
          className="text-xl font-bold cursor-pointer text-primary-color tracking-wide hover:opacity-80 transition-opacity"
        >
          StyleHub Admin & Partner
        </h1>
      </div>
