...
import com.badam.userservice.configurations.KeycloakConfig;
import com.badam.userservice.payload.dto.KeycloakRole;
import com.badam.userservice.payload.dto.KeycloakUserDTO;
import com.badam.userservice.payload.dto.KeycloakUserinfo;
import com.badam.userservice.payload.request.Credential;
import com.badam.userservice.payload.request.SignupDto;
import com.badam.userservice.payload.request.UserRequest;
import com.badam.userservice.payload.response.TokenResponse;
...
public class KeycloakUserService {
    ...
    private final String KEYCLOAK_BASE_URL;
    private final String KEYCLOAK_ADMIN_API;
    private final String TOKEN_URL;
    private final String CLIENT_ID;
    private final String clientId = "aa704f2f-87ec-492c-b100-7bc0f663442d";
    ...
    public KeycloakUserService(RestTemplate restTemplate, KeycloakConfig keycloakConfig) {
        this.restTemplate = restTemplate;
        this.keycloakConfig = keycloakConfig;
        this.KEYCLOAK_BASE_URL = keycloakConfig.getServerUrl();
        this.KEYCLOAK_ADMIN_API =
        ...
        this.CLIENT_ID = keycloakConfig.getClientId();
        this.CLIENT_SECRET = keycloakConfig.getClientSecret();
        this.username = keycloakConfig.getAdminUsername();
        this.password = keycloakConfig.getAdminPassword();
    }
    ...
    public KeycloakRole getRoleByName(String clientId, String token,String role) throws Exception {
        ...
        // Endpoint URL
        String url=KEYCLOAK_BASE_URL+"/admin/realms/" + keycloakConfig.getRealm() + "/clients/{clientId}/roles/{role}";
        // Create headers
        HttpHeaders headers = new HttpHeaders();
    ...
    public KeycloakUserDTO fetchFirstUserByUsername(String username,String token) throws Exception {
        String url = KEYCLOAK_BASE_URL+"/admin/realms/" + keycloakConfig.getRealm() + "/users?username=" + username;
    ...
    public void assignRoleToUser(String userId,
        ...
        String url = KEYCLOAK_BASE_URL+"/admin/realms/" + keycloakConfig.getRealm() + "/users/" + userId +
    ...
    public KeycloakUserinfo fetchUserProfileByJwt(String token) throws Exception {
        ...
        String url = KEYCLOAK_BASE_URL+"/realms/" + keycloakConfig.getRealm() + "/protocol/openid-connect/userinfo";
