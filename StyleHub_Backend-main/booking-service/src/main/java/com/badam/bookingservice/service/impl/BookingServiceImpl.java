package com.badam.bookingservice.service.impl;
...
import com.badam.bookingservice.repository.BookingRepository;
...
//        check availability
    ...
    public Boolean isTimeSlotAvailable(SalonDTO salon,
        ...
        for (Booking existingBooking : existingBookings) {
            // Ignore cancelled bookings when checking slot availability to unlock the slot
    ...
    public SalonReport getSalonReport(Long salonId) {
        ...
        List<Booking> bookings=getBookingsBySalon(salonId);
            ...
            // Total Earnings: Sum of totalPrice for CONFIRMED bookings
