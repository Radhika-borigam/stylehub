package com.badam.paymentservice.service.impl;

import com.badam.paymentservice.domain.PaymentMethod;
import com.badam.paymentservice.domain.PaymentOrderStatus;
import com.badam.paymentservice.entity.PaymentOrder;
import com.badam.paymentservice.exception.UserException;
import com.badam.paymentservice.messaging.BookingEventProducer;
import com.badam.paymentservice.messaging.NotificationEventProducer;
...
import com.badam.paymentservice.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService {
        ...
        if(paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)){
            ...
            if(paymentOrder.getPaymentMethod().equals(PaymentMethod.RAZORPAY)){
                ...
                if(status.equals("captured")){
                    ...
                    bookingEventProducer.sentBookingUpdateEvent(savedOrder);
    ...
    @Override
    public PaymentOrder failPaymentOrder(Long orderId) throws Exception {
